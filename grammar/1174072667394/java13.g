...
classDefinition![AST modifiers]
	:	"class" nm:IDENT
{
    SoftwareMetrics.start(nm.getText(),"Class",nm.getLine());
}
...
interfaceDefinition![AST modifiers]
	:	"interface" nm:IDENT
{
    SoftwareMetrics.start(nm.getText(), "Interface", nm.getLine());
}
		...
		(	h:ctorHead s:constructorBody // constructor
{
    SoftwareMetrics.finish();
		...
		|	t:typeSpec[false]  // method or variable declaration(s)
			(	nm:IDENT  // the name of the method
{
    SoftwareMetrics.start(nm.getText(),"Method",nm.getLine());
}
...
ctorHead
	:	nm:IDENT  // the name of the method
{
    SoftwareMetrics.start(nm.getText(),"Constructor",nm.getLine());
}
