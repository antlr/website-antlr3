 ...
 */
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("x.equalsListPartial(#(A B)) is "+(r13=x.equalsListPartial(#([A],[B]))));
		System.out.println("a.equalsTree(#(A B)) is "+(r14=a.equalsTree(#([A],[B]))));
		System.out.println("a.equalsTreePartial(#(A B)) is "+(r15=a.equalsTreePartial(#([A],[B]))));
