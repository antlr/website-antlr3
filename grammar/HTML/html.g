/*	
	...
	Alexis Hinds & Terence Parr
	Magelang Institute, Ltd.
	Send comments to:  parrt@jguru.com

	V1.3 Matthew Ford 3rd Nov. 2004
	replaced   
  ...
  replaced 
   ...
   to match <STYLE type=text/css> inputs
   I needed to add '/' to WORD.  May not be correct in general??
    Actually I think this is a IE problem as the page is actually
    <STYLE type="text/css">
    but IE stripps the " " when saving the page.
		(Actually IE strips a lot of stuff when saving)
