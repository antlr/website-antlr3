...
//
// Author:
//        Steve Eckmann        eckmann@anl.gov
//
// $Id: verilog.g,v 1.28 2000-03-27 10:46:23-07 eckmann Exp eckmann $
//
...
#include "VerilogParser.hpp"
    ...
    void parseFile(istream& s) /*throws Exception*/ {
        try {
...
options {
    exportVocab = Verilog;  // call the vocabulary "Verilog"
